...
public class ManageCustomersJPanel extends javax.swing.JPanel {
    ...
    public ManageCustomersJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem ecosystem) {
     ...
     public void populateTable(){
        ...
        model.setRowCount(0);
            ...
            for (Customer customer : ecosystem.getCustomerDirectory().getcList()) {
                Object[] row = new Object[5];
                row[0] = customer;
                row[1] = customer.getcPhoneNumber();
                row[2] = customer.getcAddress();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(103, 216, Short.MAX_VALUE))
        );
    ...
    private void btnUpdateCustActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateCustActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            txtCustAdd.setText(c.getcAddress());
            txtCustPhoneNum.setText(Long.toString(c.getcPhoneNumber()));
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        for (Customer c : ecosystem.getCustomerDirectory().getcList()) {
            if (customer.getcName().equals(c.getcName()) ) {
                c.setcName(txtCustName.getText());
                c.setcAddress(txtCustAdd.getText());
                c.setcPhoneNumber(Long.parseLong(txtCustPhoneNum.getText()));
            }
        }
