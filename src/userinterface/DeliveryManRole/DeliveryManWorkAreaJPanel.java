...
public class DeliveryManWorkAreaJPanel extends javax.swing.JPanel {
  ...
  if(order.getDeliveryManName()!=null && order.getDeliveryManName().equals(userAccount.getEmployee().getName())){
    ...
    private void initComponents() {
        ...
        processJButton.setFont(new java.awt.Font("Perpetua Titling MT", 1, 10)); // NOI18N
        ...
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 200, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 510, 96));
